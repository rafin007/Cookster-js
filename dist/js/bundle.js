...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return Search; });\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_0__);\n//Search model\r\n\r\n\r\n\r\nclass Search {\r\n    constructor(query) {\r\n        this.query = query;\r\n    }\r\n\r\n    async getResults() {\r\n        const key = '6cd3d1664a2a6315f05e383d1dc3863c';\r\n        const proxy = 'https://cors-anywhere.herokuapp.com/';\r\n        try {\r\n            const result = await axios__WEBPACK_IMPORTED_MODULE_0___default()(`${proxy}https://www.food2fork.com/api/search?key=${key}&q=${this.query}`);\r\n            this.result = result.data.recipes;\r\n            // console.log(this.recipes);\r\n        }\r\n        catch(error) {\r\n            alert(error);\r\n        }\r\n    }\r\n}\n\n//# sourceURL=webpack:///./src/js/models/Search.js?");
